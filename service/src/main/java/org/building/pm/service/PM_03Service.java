    ...
    public Map PRO_PM_03_PLAN_YEAR_SET(String V_V_GUID, String V_V_YEAR, String V_V_MONTH, String V_V_ORGCODE, String V_V_ORGNAME, String V_V_DEPTCODE, String V_V_DEPTNAME, String V_V_PORJECT_CODE, String V_V_PORJECT_NAME, String V_V_SPECIALTY,
        ...
        try {
            ...
            cstmt = conn.prepareCall("{call PRO_PM_03_PLAN_YEAR_SET" + "(:V_V_GUID,:V_V_YEAR,:V_V_MONTH,:V_V_ORGCODE,:V_V_ORGNAME,:V_V_DEPTCODE,:V_V_DEPTNAME,:V_V_PORJECT_CODE,:V_V_PORJECT_NAME,:V_V_SPECIALTY,:V_V_SPECIALTYNAME,:V_V_SPECIALTYMANCODE" +
                    ...
                    ":V_V_BJF,:V_V_CLF,:V_V_SGF,:V_V_QSTEXT,:V_INFO)}");
            cstmt.setString("V_V_GUID", V_V_GUID);
            cstmt.setString("V_V_YEAR", V_V_YEAR);
            cstmt.setString("V_V_MONTH", V_V_MONTH);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
...
//      logger.debug("params:V_V_DEPTREPAIRCODE:" + V_V_DEPTREPAIRCODE);
    ...
    public HashMap PM_03_MONTH_PLAN_SEL(String V_V_YEAR, String V_V_MONTH, String V_V_ORGCODE, String V_V_DEPTCODE, String V_V_EQUTYPE, String V_V_EQUCODE, String V_V_ZY, String V_V_CONTENT, String V_V_STATECODE, String V_V_PEROCDE, String V_V_DEPTTYPE, String V_V_INPER, String V_V_PAGE, String V_V_PAGESIZE) throws SQLException {
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PM_03_MONTH_PLAN_SEL" + "(:V_V_YEAR,:V_V_MONTH,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_EQUTYPE,:V_V_EQUCODE,:V_V_ZY,:V_V_CONTENT,:V_V_STATECODE,:V_V_PEROCDE,:V_V_DEPTTYPE,:PM_03_MONTH_PLAN_SEL,:V_V_PAGE,:V_V_PAGESIZE,:V_V_SNUM,:V_CURSOR)}");
            cstmt.setString("V_V_YEAR", V_V_YEAR);
            cstmt.setString("V_V_MONTH", V_V_MONTH);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
            cstmt.setString("V_V_DEPTCODE", V_V_DEPTCODE);
    ...
    public HashMap PM_03_MONTH_PLAN_SELALL(String V_V_YEAR, String V_V_MONTH, String V_V_ORGCODE, String V_V_DEPTCODE, String V_V_EQUTYPE, String V_V_EQUCODE, String V_V_ZY, String V_V_CONTENT, String V_V_STATECODE, String V_V_PEROCDE) throws SQLException {
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PM_03_MONTH_PLAN_SELALL" + "(:V_V_YEAR,:V_V_MONTH,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_EQUTYPE,:V_V_EQUCODE,:V_V_ZY,:V_V_CONTENT,:V_V_STATECODE,:V_V_PEROCDE,:V_CURSOR)}");
            cstmt.setString("V_V_YEAR", V_V_YEAR);
            cstmt.setString("V_V_MONTH", V_V_MONTH);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
            cstmt.setString("V_V_DEPTCODE", V_V_DEPTCODE);
...
//            result.put("total",cstmt.getString("V_V_SNUM"));
    ...
    public Map PRO_PM_PLAN_LOCKING_DATE_GET(String V_I_YEAR, String V_I_MONTH, String V_I_WEEKNUM, String V_V_TYPE, String V_V_DEPTCODE) throws SQLException {
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(true);
            cstmt = conn.prepareCall("{call PRO_PM_PLAN_LOCKING_DATE_GET" + "(:V_I_YEAR,:V_I_MONTH,:V_I_WEEKNUM,:V_V_TYPE,:V_V_DEPTCODE,:V_CURSOR)}");
    ...
    public HashMap PM_03_MONTH_PLAN_EXLALL(String V_V_YEAR, String V_V_MONTH, String V_V_ORGCODE, String V_V_DEPTCODE, String V_V_EQUTYPE, String V_V_EQUCODE, String V_V_ZY, String V_V_CONTENT, String V_V_STATECODE, String V_V_PEROCDE) throws SQLException {
        logger.info("begin PM_03_MONTH_PLAN_EXLALL");
        HashMap result = new HashMap();
        Connection conn = null;
        CallableStatement cstmt = null;
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PM_03_MONTH_PLAN_EXLALL" + "(:V_V_YEAR,:V_V_MONTH,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_EQUTYPE,:V_V_EQUCODE,:V_V_ZY,:V_V_CONTENT,:V_V_STATECODE,:V_V_PEROCDE,:V_CURSOR)}");
            cstmt.setString("V_V_YEAR", V_V_YEAR);
            cstmt.setString("V_V_MONTH", V_V_MONTH);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
            cstmt.setString("V_V_DEPTCODE", V_V_DEPTCODE);
        ...
        logger.debug("result:" + result);
        logger.info("end PM_03_MONTH_PLAN_EXLALL");
        return result;
    }

    // //PM_03010301,周,表格信息加载
    public HashMap PRO_PM_03_PLAN_WEEK_VIEW_IN(String V_V_YEAR, String V_V_MONTH, String V_V_WEEK, String V_V_ORGCODE, String V_V_DEPTCODE,
                                               String V_V_ZY, String V_V_EQUTYPE, String V_V_EQUCODE, String V_V_CONTENT, String V_V_STATE,
                                               String V_V_PAGE, String V_V_PAGESIZE, String V_V_INPER) throws SQLException {

        logger.info("begin PRO_PM_03_PLAN_WEEK_VIEW_IN");
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PRO_PM_03_PLAN_WEEK_VIEW_IN(:V_V_YEAR,:V_V_MONTH,:V_V_WEEK,:V_V_ORGCODE,:V_V_DEPTCODE," +
                    ":V_V_ZY,:V_V_EQUTYPE,:V_V_EQUCODE,:V_V_CONTENT,:V_V_STATE,:V_V_PAGE,:V_V_PAGESIZE,:V_V_INPER,:V_SUMNUM,:V_CURSOR)}");
            cstmt.setString("V_V_YEAR", V_V_YEAR);
            cstmt.setString("V_V_MONTH", V_V_MONTH);
            cstmt.setString("V_V_WEEK", V_V_WEEK);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
    ...
    public HashMap PRO_PM_MONTH_STATE_SET(String V_V_GUID, String V_V_STATE) throws SQLException {
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PRO_PM_MONTH_STATE_SET(:V_V_GUID,:V_V_STATE,:V_INFO)}");
            cstmt.setString("V_V_GUID", V_V_GUID);
            cstmt.setString("V_V_STATE", V_V_STATE);
            cstmt.registerOutParameter("V_INFO", OracleTypes.VARCHAR);
            cstmt.execute();
        ...
        logger.debug("result:" + result);
        logger.info("end PRO_PM_MONTH_STATE_SET");
        return result;
    }
