...
//      logger.debug("params:V_V_DEPTREPAIRCODE:" + V_V_DEPTREPAIRCODE);
    ...
    //-UPDATE--2018-0828
    public HashMap PRO_PM_WORKORDER_SEL_ADMINALL(String V_D_ENTER_DATE_B,String V_D_ENTER_DATE_E,String V_V_ORGCODE,String V_V_DEPTCODE,
                                                 String V_V_DEPTCODEREPARIR,String V_V_STATECODE,String V_EQUTYPE_CODE,String V_EQU_CODE,
                                                 String V_DJ_PERCODE,String V_V_SHORT_TXT,String V_V_BJ_TXT,String V_V_ORDER_TYP) throws SQLException {
        logger.info("begin PRO_PM_WORKORDER_SEL_ADMINALL");
        HashMap result = new HashMap();
        List<Map> resultList = new ArrayList<Map>();
        Connection conn = null;
        CallableStatement cstmt = null;
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(true);
            cstmt = conn.prepareCall("{call PRO_PM_WORKORDER_SEL_ADMINALL" + "(:V_D_ENTER_DATE_B,:V_D_ENTER_DATE_E,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_DEPTCODEREPARIR," +
                    ":V_V_STATECODE,:V_EQUTYPE_CODE,:V_EQU_CODE,:V_DJ_PERCODE,:V_V_SHORT_TXT," +
                    ":V_V_BJ_TXT,:V_V_ORDER_TYP,:V_V_SNUM,:V_CURSOR)}");
            cstmt.setString("V_D_ENTER_DATE_B", V_D_ENTER_DATE_B);
            cstmt.setString("V_D_ENTER_DATE_E", V_D_ENTER_DATE_E);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
            cstmt.setString("V_V_DEPTCODE", V_V_DEPTCODE);
        ...
        //result.put("list", resultList);
        logger.debug("result:" + result);
        logger.info("end PRO_PM_WORKORDER_SEL_ADMINALL");
        return result;
    }
    //--END UP
    ...
    //工单驳回修改-99
    public HashMap PRO_PM_WORKORDER_BH_EDIT(String V_V_PERCODE,String V_V_PERNAME,String V_V_ORDERGUID,String V_V_SHORT_TXT,
                                         String V_V_FUNC_LOC,String V_V_EQUIP_NO,String V_V_EQUIP_NAME,String V_D_START_DATE,
                                         String V_D_FINISH_DATE,String V_V_ORDER_TYP,String V_V_ORDER_TYP_TXT,String V_V_WBS,String V_V_WBS_TXT,String V_V_DEPTCODEREPARIR,
                                         String V_V_TOOL,String V_V_TECHNOLOGY,String V_V_SAFE,String V_D_DATE_ACP,String V_I_OTHERHOUR,
                                         String V_V_OTHERREASON,String V_V_REPAIRCONTENT, String V_V_REPAIRSIGN,String V_V_REPAIRPERSON,
                                         String V_V_POSTMANSIGN,String V_V_CHECKMANCONTENT,String V_V_CHECKMANSIGN,String V_V_WORKSHOPCONTENT,
                                         String V_V_WORKSHOPSIGN,String V_V_DEPTSIGN)throws SQLException {
        ...
        logger.info("begin PRO_PM_WORKORDER_BH_EDIT");
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PRO_PM_WORKORDER_BH_EDIT(:V_V_PERCODE,:V_V_PERNAME,:V_V_ORDERGUID,:V_V_SHORT_TXT,:V_V_FUNC_LOC," +
                    ":V_V_EQUIP_NO,:V_V_EQUIP_NAME,:V_D_START_DATE,:V_D_FINISH_DATE,:V_V_ORDER_TYP,:V_V_ORDER_TYP_TXT,:V_V_WBS,:V_V_WBS_TXT,:V_V_DEPTCODEREPARIR," +
                    ":V_V_TOOL,:V_V_TECHNOLOGY,:V_V_SAFE,:V_D_DATE_ACP,:V_I_OTHERHOUR,:V_V_OTHERREASON,:V_V_REPAIRCONTENT,:V_V_REPAIRSIGN," +
                    ":V_V_REPAIRPERSON,:V_V_POSTMANSIGN,:V_V_CHECKMANCONTENT,:V_V_CHECKMANSIGN,:V_V_WORKSHOPCONTENT,:V_V_WORKSHOPSIGN," +
                    ":V_V_DEPTSIGN,:V_INFO)}");
            cstmt.setString("V_V_PERCODE", V_V_PERCODE);
            ...
            cstmt.setString("V_D_FINISH_DATE", V_D_FINISH_DATE);
            cstmt.setString("V_V_ORDER_TYP", V_V_ORDER_TYP);
            cstmt.setString("V_V_ORDER_TYP_TXT", V_V_ORDER_TYP_TXT);
            cstmt.setString("V_V_WBS", V_V_WBS);
            cstmt.setString("V_V_WBS_TXT", V_V_WBS_TXT);
            cstmt.setString("V_V_DEPTCODEREPARIR", V_V_DEPTCODEREPARIR);
            cstmt.setString("V_V_TOOL", V_V_TOOL);
        ...
        logger.debug("result:" + result);
        logger.info("end PRO_PM_WORKORDER_BH_EDIT");
        return result;
    }
    /**
     * 周计划生成工单保存
     */
    public HashMap PRO_PM_WORK_FWEEK_DEFECT_SAVE(String V_V_PERNAME,String  V_DEFECT_GUID,String  V_V_ORDERGUID,String  V_V_EQUCODE,
                                                String V_V_WORKORDER_TYPE,String V_V_DEPTCODEREPARIR,String V_V_SHORT_TXT,String V_V_WBS,
                                                String V_V_WBS_TXT,String V_D_START_DATE,String V_D_FINISH_DATE) throws SQLException {

        logger.info("begin PRO_PM_WORK_FWEEK_DEFECT_SAVE");
//      logger.debug("params:V_V_DEPTREPAIRCODE:" + V_V_DEPTREPAIRCODE);
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(true);
            cstmt = conn.prepareCall("{call PRO_PM_WORK_FWEEK_DEFECT_SAVE" + "(:V_V_PERNAME,:V_DEFECT_GUID," +
                    ":V_V_ORDERGUID,:V_V_EQUCODE,:V_V_WORKORDER_TYPE,:V_V_DEPTCODEREPARIR,:V_V_SHORT_TXT,:V_V_WBS,:V_V_WBS_TXT," +
                    ":V_D_START_DATE,:V_D_FINISH_DATE,:V_CURSOR)}");
            cstmt.setString("V_V_PERNAME", V_V_PERNAME);
            cstmt.setString("V_DEFECT_GUID", V_DEFECT_GUID);
        ...
        logger.debug("result:" + result);
        logger.info("end PRO_PM_WORK_FWEEK_DEFECT_SAVE");
        return result;
    }
    ...
    //被单工单的导出过程查询
    public HashMap PRO_PM_WORKORDER_SEL_NOBJ(String V_D_ENTER_DATE_B,String V_D_ENTER_DATE_E,String V_V_ORGCODE,String V_V_DEPTCODE,
                                                 String V_V_DEPTCODEREPARIR,String V_V_STATECODE,String V_EQUTYPE_CODE,String V_EQU_CODE,
                                                 String V_DJ_PERCODE,String V_V_SHORT_TXT,String V_V_BJ_TXT,String V_V_ORDER_TYP) throws SQLException {
        logger.info("begin PRO_PM_WORKORDER_SEL_NOBJ");
        HashMap result = new HashMap();
        List<Map> resultList = new ArrayList<Map>();
        Connection conn = null;
        CallableStatement cstmt = null;
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(true);
            cstmt = conn.prepareCall("{call PRO_PM_WORKORDER_SEL_NOBJ" + "(:V_D_ENTER_DATE_B,:V_D_ENTER_DATE_E,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_DEPTCODEREPARIR," +
                    ":V_V_STATECODE,:V_EQUTYPE_CODE,:V_EQU_CODE,:V_DJ_PERCODE,:V_V_SHORT_TXT," +
                    ":V_V_BJ_TXT,:V_V_ORDER_TYP,:V_V_SNUM,:V_CURSOR)}");
            cstmt.setString("V_D_ENTER_DATE_B", V_D_ENTER_DATE_B);
            cstmt.setString("V_D_ENTER_DATE_E", V_D_ENTER_DATE_E);
        ...
        //result.put("list", resultList);
        logger.debug("result:" + result);
        logger.info("end PRO_PM_WORKORDER_SEL_NOBJ");
        return result;
    }
    public HashMap PRO_PM_WORKORDER_SELECT_N(String V_D_ENTER_DATE_B,String V_D_ENTER_DATE_E,String V_V_ORGCODE,String V_V_DEPTCODE,
                                                 String V_V_DEPTCODEREPARIR,String V_V_STATECODE,String V_EQUTYPE_CODE,String V_EQU_CODE,
        ...
        logger.info("begin PRO_PM_WORKORDER_SELECT_N");
        HashMap result = new HashMap();
        List<Map> resultList = new ArrayList<Map>();
        Connection conn = null;
        CallableStatement cstmt = null;
        ...
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(true);
            cstmt = conn.prepareCall("{call PRO_PM_WORKORDER_SELECT_N" + "(:V_D_ENTER_DATE_B,:V_D_ENTER_DATE_E,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_DEPTCODEREPARIR," +
                    ":V_V_STATECODE,:V_EQUTYPE_CODE,:V_EQU_CODE,:V_DJ_PERCODE,:V_V_SHORT_TXT," +
        ...
        //result.put("list", resultList);
        logger.debug("result:" + result);
        logger.info("end PRO_PM_WORKORDER_SELECT_N");
        return result;
    }
    /**
     * workorder query page select tab work num
     * by hrb 2019-8-22
     */
    public HashMap PRO_PM_WORKTYPCOUNT_N(String V_D_ENTER_DATE_B,String V_D_ENTER_DATE_E,String V_V_ORGCODE,String V_V_DEPTCODE,
                                             String V_V_DEPTCODEREPARIR,String V_V_STATECODE,String V_EQUTYPE_CODE,String V_EQU_CODE,
                                             String V_DJ_PERCODE,String V_V_SHORT_TXT,String V_V_BJ_TXT,String V_V_WORKID) throws SQLException {
        logger.info("begin PRO_PM_WORKTYPCOUNT_N");
        HashMap result = new HashMap();
        List<Map> resultList = new ArrayList<Map>();
        Connection conn = null;
        CallableStatement cstmt = null;
        try {
            conn = dataSources.getConnection();
            conn.setAutoCommit(false);
            cstmt = conn.prepareCall("{call PRO_PM_WORKTYPCOUNT_N" + "(:V_D_ENTER_DATE_B,:V_D_ENTER_DATE_E,:V_V_ORGCODE,:V_V_DEPTCODE,:V_V_DEPTCODEREPARIR,:V_V_STATECODE,:V_EQUTYPE_CODE,:V_EQU_CODE,:V_DJ_PERCODE,:V_V_SHORT_TXT,:V_V_BJ_TXT,:V_V_WORKID,:V_CURSOR)}");
            cstmt.setString("V_D_ENTER_DATE_B", V_D_ENTER_DATE_B);
            cstmt.setString("V_D_ENTER_DATE_E", V_D_ENTER_DATE_E);
            cstmt.setString("V_V_ORGCODE", V_V_ORGCODE);
            cstmt.setString("V_V_DEPTCODE", V_V_DEPTCODE);
