            ...
            items: [
                {
                    ...
                    items: [{
                        ...
                        {xtype: 'button', text: '手动添加', handler: addbtn, icon: imgpath + '/add.png'},
                        {xtype: 'button', text: '模型添加', handler: selectModel, icon: imgpath + '/add.png'},
        ...
        Ext.Ajax.request({
            ...
            params: {
                parName: ['V_V_GUID',
                    ...
                    'V_V_EQUTYPE',//设备类型
                    'V_V_EQUCODE',//设备编码
                    'V_V_EQUCHILD_CODE',//部位编码
                    'V_V_FAULT_GUID',//故障字典GUID
                    'V_V_FAULT_TYPE',//故障类型
                    'V_V_FAULT_YY',//故障原因
                    'V_V_FINDTIME',//发选时间
                    'V_V_FAULT_XX',//故障现象
                    'V_V_JJBF',    //解决办法
                    'V_V_FAULT_LEVEL',//故障等级
                    'V_V_FILE_GUID',//附件guid
                    'V_V_INTIME',//录入时间
                    'V_V_PERCODE',//录入人
                    'V_V_IP'      //录入IP
                ],
                ...
                parVal: [
                    V_V_GUID,
                    Ext.getCmp('winck').getValue(),//单位编码
                    Ext.getCmp('winzyq').getValue(),//作业区编码
                    Ext.getCmp('winsbtype').getValue(),//设备类型
                    Ext.getCmp('winsbname').getValue(),//设备编码
                    Ext.getCmp('winsubequname').getValue(),//部位编码
                    fault_guid,                        //故障字典GUID
                    Ext.getCmp('wingztype').getValue(),//故障类型
                    Ext.getCmp('wingzyy').getValue(),//故障原因
                    Ext.getCmp('winfxsj').getSubmitValue(),//发选时间
                    Ext.getCmp('wingzxx').getValue(),//故障现象
                    Ext.getCmp('winjjff').getValue(), //解决办法
                    Ext.getCmp('wingzdj').getValue(),//故障等级
                    file_guid,                                  //附件guid
                    Ext.util.Format.date(new Date(), 'Y-m-d'),//录入时间
                    Ext.util.Cookies.get('v_personcode'),       //录入人
                    Ext.fly('localIp').getValue()               //录入IP
                ],
