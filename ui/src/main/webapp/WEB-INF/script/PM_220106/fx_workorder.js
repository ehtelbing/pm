/**
 * Created on 2019/4/11 for maintain create workorder.
 */
var V_GUID = null;
    ...
    $.ajax({
        ...
        success: function (resp) {
            if (resp.list != "" && resp.list != null) {
                ...
                $("#personCode").html(resp.list[0].V_PERSONNAME);
                $("#createDate").html(Ext.Date.format(new Date(resp.list[0].D_ENTER_DATE), "Y-m-d"));

                $("#selPlant").val(resp.list[0].V_DEPTCODEREPAIR);
            }
        }
    });
}
