    ...
    listeners:{
        'itemdblclick':function(a,b,c){
            /*var owidth = window.screen.availWidth;
             ...
             var ret = window.open(AppUrl + 'page/pm_dxgc_bz01/gantt.html?guid='
             +  b.data.V_GUID+'&&fxjhbm=' +b.data.V_PROJECT_CODE+'&&fxjhmc='+b.data.V_PROJECT_NAME+'&&fxjhguid='+ b.data.V_GUID+'&&deptcode='+Ext.getCmp('ck').getValue(), '', 'height='+ oheight +'px,width= '+ owidth + 'px,top=50px,left=100px,resizable=yes');
             */
            var owidth = 593;
            var oheight = 796;
            var w=screen.availWidth-10;
            var h=screen.availHeight-30;
            var objwin = window.open(AppUrl + 'page/pm_dxgc_bz99/index.html?guid='+b.data.V_GUID
            ...
            /*var ret = window.open(AppUrl + 'page/pm_dxgc_bz99/index.html?guid='+b.data.V_GUID
             + "&V_PROJECT_NAME=" + b.data.V_PROJECT_NAME
             + "&V_PROJECT_CODE=" + b.data.V_PROJECT_CODE, '', 'height=796px,width=593px,top=50px,left=100px,resizable=yes');*/
