                ...
                items: [
                    {
                        ...
                        width: 80,
                        handler: function () {
                            if (Ext.ComponentManager.get("tree1hidden").getValue() == "") {
                                alert('请选择部门进行添加');
                            } else {
                                Ext.ComponentManager.get("rybm").setValue('');
                                Ext.ComponentManager.get("rymc").setValue('');
                                Ext.ComponentManager.get("login").setValue('');
                                Ext.ComponentManager.get("password").setValue('');
                                Ext.ComponentManager.get("gz").setValue('');
                                 Ext.ComponentManager.get("editzyq").setValue(Ext.ComponentManager.get("tree1hidden").getValue());
                                Ext.getCmp("editgzzx").select('');
                                ...
                                Ext.getCmp('rybm').setReadOnly(false);
                            ...
                            if (id == '0' || id > 1) {
                                    ...
                                    Ext.Ajax
                                        .request({
                                            ...
                                            success: function (resp) {
                                                ...
                                                Ext.ComponentManager.get("rolewin").select(response.list[0].V_ROLECODE);
                                                Ext.getCmp('editzyq').setValue(response.list[0].V_DEPTCODE);
                                                Ext.getCmp('editgzzx').setValue(response.list[0].V_CLASS_CODE);
                                ...
                                Ext.Ajax
                                    .request({
                                        ...
                                        success: function (resp) {
                                            re = Ext.JSON.decode(resp.responseText);
                                            if (re.list != '') {
                                                Ext.getCmp('gz').setValue(re.list[0].V_CRAFTCODE);
                                            } else {
                                                Ext.getCmp('gz').setValue('');
                                            }
                                ...
                                Ext.getCmp('rybm').setReadOnly(true);
                            }
                        }
                                ...
                                Ext.Msg
                                    ...
                                    function (button) {
                                        ...
                                        for (i = 0; i < Ext.getCmp('grid').getSelectionModel().getSelection().length; i++) {
                                            ...
                                            Ext.Ajax.request({
                                                    url: AppUrl + 'zdh/PRO_BASE_PERSON_DEL',
                                                    method: 'POST',
                                                    params: {
                                            ...
                                            Ext.Ajax.request({
                                                    url: AppUrl + 'zdh/PRO_PERSON_DELETE_CRAFT',
                                                    method: 'POST',
                                                    params: {
        ...
        function () {
            if (Ext.ComponentManager.get("rybm").getValue() == ""
                ...
                Ext.Ajax.request({
                    ...
                    success: function () {
                        for (var i = 0; i < Ext.data.StoreManager.get('store2').tree.root.childNodes.length; i++) {
                            Ext.Ajax.request({
                                    url: AppUrl + 'zdh/PRO_BASE_POSTTOPERSON_SET',
                                    method: 'POST',
                                    params: {
