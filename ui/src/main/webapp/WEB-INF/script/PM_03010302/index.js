...
function OnButtonDefectAddClicked() {
    V_WEEKPLAN_GUID = 0;
    V_PLANTYPE = 'DEFECT';
    var ret = window.open(AppUrl + 'page/PM_03010310/index.html?V_PLANTYPE=' + V_PLANTYPE +
...
function OnButtonEditClicked() {
    ...
    V_WEEKPLAN_GUID = seldata[0].data.V_WEEKPLAN_GUID;
...
function OnButtonDelete() {
    ...
    for (var i = 0; i < length; i++) {
        Ext.Ajax.request({
            ...
            async: false,
            params: {
                V_V_WEEKPLAN_GUID: Ext.getCmp('gridPanel').getSelectionModel().getSelection()[i].data.V_WEEKPLAN_GUID
            },
