Ext.onReady(function() {
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        fields : ['I_ID', 'V_CODE_YEAR', 'I_YEAR','V_DEPTCODE', 'V_DEPTNAME', 'V_DEPTNEXTCODE', 'V_DEPTNEXTNAME',
            ...
            'V_PERSONNAME','V_STATUS','V_STATUSNAME','V_MX_NAME'],
    ...
    var panel=Ext.create('Ext.panel.Panel',{
        ...
        items:[{id: 'year', store: Ext.create("Ext.data.Store", {
        ...
        }), xtype: 'combo', fieldLabel: '年份',  value: new Date().getFullYear(), labelWidth: 60,labelAlign:'right', editable: false, displayField: 'displayField', valueField: 'valueField'},
            { xtype: 'combo', id: "ck", store: ckStore, editable: false, queryMode: 'local', fieldLabel: '计划厂矿', displayField: 'V_DEPTNAME', valueField: 'V_DEPTCODE', labelWidth: 60, labelAlign: 'right' },
            { xtype: 'combo', id: "zyq", store: zyqStore, editable: false, queryMode: 'local', fieldLabel: '作业区', displayField: 'V_DEPTNAME', valueField: 'V_DEPTCODE', labelWidth: 60, labelAlign: 'right'},
            {
                id: 'sbtype',
                xtype: 'combo',
                store: ssbtype,
            ...
            {xtype:'button',text:'放行', listeners:{click:''}}]
    });
    ...
    var grid=Ext.create('Ext.grid.Panel',{
        ...
        columns:[{ xtype: 'rownumberer',text: '序号', width: 40, sortable: false },
            ...
            { text: '检修模型描述', width: 120, dataIndex: 'V_MX_NAME', align: 'center', renderer : atleft },
