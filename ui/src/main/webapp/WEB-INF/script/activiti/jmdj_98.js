...
Ext.onReady(function () {
                ...
                columns: [
                    {
                        ...
                        text: '电机', dataIndex: 'V_DJ', flex: 1, field: {xtype: 'checkbox'},
                        align: 'center',
                        renderer: function isflage(value, metaData, record, rowIdx, colIdx, store, view) {
                        ...
                        text: '探伤', dataIndex: 'V_TS', flex: 1, field: {xtype: 'checkbox'},
                        align: 'center',
                        renderer: function isflage(value, metaData, record, rowIdx, colIdx, store, view) {
                        ...
                        text: '电缆', dataIndex: 'V_DL', flex: 1, field: {xtype: 'checkbox'},
                        align: 'center',
                        renderer: function isflage(value, metaData, record, rowIdx, colIdx, store, view) {
                        ...
                        text: '热像', dataIndex: 'V_RX', flex: 1, field: {xtype: 'checkbox'},
                        align: 'center',
                        renderer: function isflage(value, metaData, record, rowIdx, colIdx, store, view) {
    ...
    var gridPanel4 = Ext.create('Ext.panel.Panel', {
        ...
        baseCls: 'my-panel-no-border',
        border: false,
        items: [{region: 'north', height: '60%', layout: 'fit', items: [gridPanel1]}, {
            region: 'center',
            height: '40%',
            layout: 'fit',
            items: [gridPanel3]
...
var pageFunction = {
    ...
    editorJmdj: function (editor, e, eOpts) {
        //将复选框的对应字段，默认值为true，将true转换成数字传给后台
        if (e.field == 'V_ZD' || e.field == 'V_DJ' || e.field == 'V_TS' || e.field == 'V_DL' || e.field == 'V_RX') {
            if (e.value == true) {
                e.value = 1;
            } else {
                e.value = 0;
