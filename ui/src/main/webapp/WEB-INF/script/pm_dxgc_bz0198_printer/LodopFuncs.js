function getLodop(oOBJECT, oEMBED) {
    ...
    **************************/
    var strHtml1 = "<br><font color='#FF00FF'>打印控件未安装!点击这里<input type='button' onclick='btnAnZhuang()' value='执行安装'/>,安装后重新进入。</font>";
    var strHtml2 = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<input type='button' onclick='btnAnZhuang()' value='执行升级'/>,升级后请重新进入。</font>";
...
function btnAnZhuang() {
    //window.open(AppUrl+"/No410101/printDefault.html");
	location.href=AppUrl+"page/No410101/install_lodop32.exe";
}
