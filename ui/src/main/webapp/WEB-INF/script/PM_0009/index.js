...
var centerP = Ext.create('Ext.grid.Panel', {
    ...
    columns: [
        ...
        {text: '计划数', align: 'center', dataIndex: 'index2'},
        {text: '审批数', align: 'center', dataIndex: 'index3'},
        {text: '入库单', align: 'center', dataIndex: 'index3'},
        {text: '领用单', align: 'center', dataIndex: 'index3'}
    ]
