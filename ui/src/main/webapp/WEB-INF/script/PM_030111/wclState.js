...
Ext.onReady(function () {
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        id: 'gridStore',
        autoLoad: false,
        fields: ['V_ORGCODE','V_ORGNAME','V_DEPTCODE', 'V_DEPTNAME', 'V_V_SUMNUM', 'V_V_YXQNUM', 'V_V_WCLNUM'],
        proxy: {
            type: 'ajax',
            async: false,
            url: AppUrl + 'cgl/PM_03_PLAN_CKSTAT_SEL_WCL',
            actionMethods: {
                read: 'POST'
            },
            reader: {
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {text: '完成率（%)', align: 'center', width: 190, dataIndex: 'V_V_WCLNUM',renderer:left},
        ]
...
function OnClickExcelButton() {
    ...
    document.location.href = AppUrl + 'excel/ZJH_EXCEL_WCL?V_V_YEAR=' + Ext.getCmp('nf').getValue()
