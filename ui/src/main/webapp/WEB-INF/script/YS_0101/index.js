...
Ext.onReady(function () {
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: AppUrl + 'YS/ys_report_charge_dept_sel',
            reader: {
                type: 'json',
                root: 'list',
                total: 'total'
    ...
    var gridStore2 = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: AppUrl + 'YS/ys_report_charge_cost_sel',
            reader: {
                type: 'json',
                root: 'list',
                total: 'total'
...
function _querySum(){
    Ext.Ajax.request({
        url: AppUrl + 'YS/YS_REPORT_CHARGE_ORG_TOTAL_SEL',
        async: false,
        method: 'POST',
        params: {
...
function _querySum2(){
    Ext.Ajax.request({
        url: AppUrl + 'YS/YS_REPORT_CHARGE_C_TOTAL_SEL',
        async: false,
        method: 'POST',
        params: {
            'V_I_YEAR':  Ext.getCmp('year').getValue(),
