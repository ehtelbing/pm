        ...
        success: function (resp) {
            if (resp.list == "" || resp.list == null) {
                ...
                var ret = window.open(AppUrl
                    + 'page/No41020101/Index.html?V_ORDERGUID='
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (resp != "" && resp != null) {
                ...
                $("#V_SHORT_TXT").val(resp[0].V_SHORT_TXT);
                ...
                if (resp[0].D_DATE_ACP != "") {
                    $("#D_DATE_ACP").val(resp[0].D_DATE_ACP);
                } else {
                    $("#D_DATE_ACP").val(resp[0].D_FINISH_DATE);
                }
