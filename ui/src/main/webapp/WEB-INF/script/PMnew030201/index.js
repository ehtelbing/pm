            ...
            for (let k = tempIndex; k <= this.tableTdSum; k++) {
                ...
                if (k == 0) {
                    ...
                    if (leftNoStartDay - tempIndex + 1 > 0) {
                        ...
                        tempHtmlContent += '<td><div class = "svgDivX" style="width: ' + (leftNoStartDay - tempIndex) * 26 + 'px"><svg xmlns="http://www.w3.org/2000/svg" width="' + ((leftNoStartDay - tempIndex) * 26) + '"  height="23"><polygon points="0 8 '+ jtwidth1 +' 8 '+ jtwidth1 +' 4 '+ jtwidth +' 11 '+ jtwidth1 +' 18 '+ jtwidth1 +' 14 0 14" stroke="none" fill="black"></polygon></svg></div></td>';
                    }
