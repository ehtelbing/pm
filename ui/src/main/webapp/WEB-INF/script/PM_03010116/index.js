...
//计划类型
var jhlxData = [{'displayField': '年计划', 'valueField': 'YEAR'}];
...
var gridPanel = Ext.create('Ext.grid.Panel', {
    ...
    columns: [
        ...
        {text: '车间名称', align: 'center', width: 140, dataIndex: 'V_DEPTNAME'},
        {text: '专业', align: 'center', width: 100, dataIndex: 'V_REPAIRMAJOR_CODE'},
        {text: '设备名称', align: 'center', width: 140, dataIndex: 'V_EQUNAME'},
        {xtype: 'linebreakcolumn',text: '检修内容', align: 'center', width: 250, dataIndex: 'V_CONTENT'},
        {text: '计划停机日期', align: 'center',width : 170, dataIndex: 'V_STARTTIME',
            renderer: rendererTime},
        {text: '计划竣工日期', align: 'center', width : 170, dataIndex: 'V_ENDTIME',
            renderer: rendererTime},
