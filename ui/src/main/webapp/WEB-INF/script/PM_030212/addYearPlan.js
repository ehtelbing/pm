...
var northPanel = Ext.create('Ext.form.Panel', {
    ...
    defaults: {bodyCls:'border_wid',labelAlign: 'center'},
    collapsible: false,
    tbar: [
        ...
        //     iconCls: 'Tablegear',
        //     handler: btnAdd_file
        // }, {xtype: 'label', id: 'label11', width: 55, text: '附件数量'}, {
        //     xtype: 'label',
        //     id: 'fjsl',
        //     width: 30,
        //     margin: '5 0 5 0'
...
Ext.onReady(function () {
    ...
    new Ext.Viewport({
        ...
        items: [{
            ...
            border:false,
            padding:'0 0 5 0',
            style:'width:100%;background-color:rgb(229,236,240)',
            items:[fsf]
