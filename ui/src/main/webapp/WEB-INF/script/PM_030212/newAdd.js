...
var northPanel = Ext.create('Ext.form.Panel', {
    ...
    tbar: [
        ...
        ,
        {xtype: 'tbseparator', bodyCls: 'border_wid', margin: '8 8 5 8', hidden: true},
        {
            xtype: 'button',
            text: '附件',
            margin: '0 0 5 0',
        ...
        {xtype: 'label', id: 'label11', width: 55, text: '附件数量', margin: '5 0 5 0', hidden: true},
        {
            xtype: 'label',
            id: 'fjsl',
            width: 30,
...
var ToolpanelC = Ext.create('Ext.form.Panel', {
    ...
    items: [
        ...
        },
        {
            ...
            listeners: {
                select: function () {
                    Ext.getCmp('etime').setValue(Ext.getCmp('btime').getValue())
                    Ext.getCmp('etime').setMinValue(Ext.getCmp('btime').getValue())
                }
            }
        },
        {
...
function btnAdd_file() {
    var owidth = window.document.body.offsetWidth - 600;
    var oheight = window.document.body.offsetHeight - 100;
    window.open(AppUrl + 'page/PM_030212/yearFile.html?guid=' + yearguid + '&type=YEAR&random=' + Math.random(), '', 'height=' + oheight + ',width=' + owidth + ',top=10px,left=10px,resizable=yes');
}
