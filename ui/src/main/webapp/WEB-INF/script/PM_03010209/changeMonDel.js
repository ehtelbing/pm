...
if (location.href.split("?")[1] != undefined) {
    monthGuid = Ext.urlDecode(location.href.split('?')[1]).mguid;
...
Ext.onReady(function () {
    ...
    var cyGridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            {text: '检修内容', align: 'center', width: 200, dataIndex: 'V_EQUNAME', renderer: atleft},
...
function turnPage(){
    window.opener.OnButtonUpdateClick();
    window.close();
}
