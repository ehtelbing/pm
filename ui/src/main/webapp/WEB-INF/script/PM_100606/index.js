...
Ext.onReady(function () {
    ...
    var departDrawStore = Ext.create('Ext.data.Store', {
        storeId: 'departDrawStore',
        autoLoad: false,
        pageSize: 100,
        fields: ['DEPARTNAME', 'OIL_AMOUNT'],
        proxy: {
            url: AppUrl + 'mwd/GET_DEPART_DRAW',
            async: false,
            type: 'ajax',
            actionMethods: {
                read: 'POST'
    ...
    var departDrawChart = Ext.create('Ext.chart.Chart', {
        id: 'departDrawChart',
        store: departDrawStore,
        //title: '年预算分解情况',
        frame: true,
        animate: true,
        shadow: true,
...
function _selectOilPriceDraw() {
    ...
    var departDrawStore = Ext.data.StoreManager.lookup('departDrawStore');
    departDrawStore.proxy.extraParams = {
