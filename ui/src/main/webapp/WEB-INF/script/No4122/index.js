...
Ext.onReady(function () {
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        height: 400,
        columns: [
            {text: '设备编号', width : 150, dataIndex: 'V_EQUCODE', align: 'center'},
            {text: '设备名称', width : 160, dataIndex: 'V_EQUNAME', align: 'center'},
            {text: '大小/尺寸',  width : 150, dataIndex: 'V_SIZE', align: 'center'},
            {text: '制造商', width : 150,  dataIndex: 'V_ZZS', align: 'center'},
            {text: '厂矿', width : 100,  dataIndex: 'V_ORGNAME', align: 'center'},
            {text: '作业区', width : 130,  dataIndex: 'V_DEPTNAME', align: 'center'},
            {text: '功能位置',  width : 160, dataIndex: 'V_EQUSITE', align: 'center'},
            {text: '描述', width : 200, dataIndex: 'V_EQUSITENAME', align: 'center'},
            {text: '成本中心',  width : 150,  dataIndex: 'V_CBZX', align: 'center'}
            ],
        bbar: [{
            id: 'page',
            xtype: 'pagingtoolbar',
