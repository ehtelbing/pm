...
// 	window.open(AppUrl + 'page/PM_0301011001/index.html?V_YEAR='+year+'&V_MONTH='+ month+
// 		'&V_WEEK='+week+'&V_TYPE=W','', "dialogWidth=460px;dialogHeight=280px");
// }
...
function OnButtonSetupClicked(){
    ...
    V_WEEK=Ext.getCmp('week').getValue();
...
function OnButtonCancelClicked(){
    if (navigator.userAgent.indexOf("Firefox") != -1 || navigator.userAgent.indexOf("Chrome") !=-1) {
        window.location.href="http://localhost:8080/pm/app/pm/page/PM_03010314/index.html";
        window.close();
    } else {
        window.opener = null;
        window.open("", "_self");
