...
Ext.onReady(function () {
    ...
    Ext.Ajax.request({
        url: AppUrl + 'mwd/PM_REAPIR_STANDARD_DATA_GET',
        type: 'ajax',
        method: 'POST',
        params: {
            'V_V_GUID': V_V_GUID,
...
function _init() {
    if (jsStandardGetLoad && deptStoreLoad && sbTypeStoreLoad && sbNameStoreLoad) {
        ...
        Ext.getCmp('V_V_EQUCODE').setValue(jsStandardGet[0].V_EQUCODE);
        Ext.getCmp('V_V_EQUNAME').setValue(jsStandardGet[0].V_EQUNAME);
        Ext.getCmp('V_V_PROJECT_IMG').setValue(jsStandardGet[0].V_PROJECT_IMG);
        Ext.getCmp('V_V_WORK_BEFORE').setValue(jsStandardGet[0].V_WORK_BEFORE);
        Ext.getCmp('V_V_WORK_PER').setValue(jsStandardGet[0].V_WORK_PER);
        Ext.getCmp('V_V_WORK_CRAFT').setValue(jsStandardGet[0].V_WORK_CRAFT);
        Ext.getCmp('V_V_WORK_TOOL').setValue(jsStandardGet[0].V_WORK_TOOL);
        Ext.getCmp('V_V_WORK_TIME').setValue(jsStandardGet[0].V_WORK_TIME);
        Ext.getCmp('V_V_SUM_TIME').setValue(jsStandardGet[0].V_SUM_TIME);
        Ext.getCmp('V_V_WORK_AQ').setValue(jsStandardGet[0].V_WORK_AQ);
        Ext.getCmp('V_V_WORK_DEPT').setValue(jsStandardGet[0].V_WORK_DEPT);
        Ext.getCmp('V_V_REPAIR').setValue(jsStandardGet[0].V_REPAIR_NAME);
        Ext.getCmp('V_V_WORK_CODE').setValue(jsStandardGet[0].V_WORK_CODE);
        Ext.getCmp('V_V_WORK_NAME').setValue(jsStandardGet[0].V_WORK_NAME);
