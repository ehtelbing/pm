...
//导出excel
function onBtnExcel() {
    document.location.href = AppUrl + 'excel/BZZJSGD_EXCEL?V_D_ENTER_DATE_B=' + Ext.util.Format.date(Ext.getCmp('begintime').getValue(), 'Y-m-d')
        + '&V_D_ENTER_DATE_E=' + Ext.util.Format.date(Ext.getCmp('endtime').getValue(), 'Y-m-d')
        + '&V_V_ORGCODE=' + Ext.getCmp('ck').getValue()
        + '&V_V_DEPTCODE=' + encodeURI(Ext.getCmp('zyq').getValue())
        + '&V_V_DEPTCODEREPARIR=' + ''
        + '&V_V_STATECODE=' + encodeURI(Ext.getCmp('gdzt').getValue())
        + '&V_EQUTYPE_CODE=' + encodeURI(Ext.getCmp('sblx').getValue())
        + '&V_EQU_CODE=' + encodeURI(Ext.getCmp('sbmc').getValue())
        + '&V_DJ_PERCODE=' + encodeURI("%")
        + '&V_V_SHORT_TXT=' + Ext.getCmp('selshortTxt').getValue()
        + '&V_V_BJ_TXT=' + ''
        + '&V_V_ORDER_TYP=' + encodeURI("%")
