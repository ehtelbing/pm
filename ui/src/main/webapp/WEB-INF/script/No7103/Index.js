Ext.onReady(function () {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                Ext.ComponentManager.get('dqbjms_id').setValue(code);
            }
        });
...
function OnButtonAddClicked() {
    Ext.Ajax
        .request({
            ...
            method: 'POST',
            params: {
                A_BJ_ID: Ext.getCmp('dqbjms_id').getValue(),
...
function beforeloadStore(store) {
    ...
    store.proxy.extraParams.parVal = [Ext.urlDecode(location.href.split('?')[1]).V_MPCODE];
