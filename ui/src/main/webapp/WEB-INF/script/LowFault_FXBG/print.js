        ...
        $.ajax({
            ...
            success: function (resp) {
                for (var x = 0; x < max; x++) {
                    ...
                    // result.push('               <caption style="font-size:22px">设备故障预案</caption>');

                    result.push('        <tr>');
                    result.push('        <td valign="top">');
                    result.push('            <table class="Ttable" width="90%" align="center" border="0" cellspacing="0" cellpadding="0">');
                    result.push('                <tr>');
                    result.push('                    <td align="center" valign="bottom" width="200" style="height:17mm;font-size:22px">设备故障预案');
                    result.push('                    </td>');
                    result.push('                </tr>');
                    result.push('                <tr>');
                    result.push('                    <td align="left" valign="bottom" width="200" style="height:10mm">故障名称:');
                    ...
                    result.push('                <tr>');
                    result.push('                    <td class="" align="left" valign="bottom" width="200" style="height:9mm">');
                    result.push('                        4、故障抢修队伍所需的设备及准备的检修机具');
                    result.push('                    </td>');
                    result.push('                </tr>');
                    result.push('                <tr>');
                    result.push('                    <td class="border_r_t" align="left" width="200" style="height:17mm">');
