...
Ext.onReady(function () {
    ...
    var faultItemStore = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            url: AppUrl + 'cxy/PM_BUG_PLAN_SEL',
            type: 'ajax',
            async: false,
            actionMethods: {
                read: 'POST'
...
function _updateOpen(value) {
    ...
    window.open(AppUrl + 'page/LowFault_FXBG/update.html?V_V_GUID=' + value,'', 'height=' + oheight + 'px,width= ' + owidth + 'px,top=50px,left=100px,resizable=yes,autoScroll=true');
}
