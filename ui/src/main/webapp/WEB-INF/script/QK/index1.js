...
var gridStore = Ext.create("Ext.data.Store", {
    ...
    pageSize: 20,
    fields: [
        'V_ITEMCODE', 'V_ITEMNAME', 'V_TIME_B', 'V_TIME_E', 'V_FILEGUID',
        'V_MAJOR', 'V_MONEY', 'V_BUDGET_MONEY', 'V_EXPLAIN', 'V_SCHEME', 'V_FILENAME'
    ],
    proxy: {
        type: 'ajax',
        async: false,
            ...
            items: [
                ...
                },
                {
                    ...
                    columns: [
                        ...
                        {
                            text: '缺陷图片', dataIndex: 'V_FILENAME', align: 'center', width: 150,
...
function onDownload(fileguid, filename) {
    location.href = AppUrl + "qk/downloadFile?V_V_FILEGUID=" + fileguid + "&V_V_FILENAME=" + filename;
}
