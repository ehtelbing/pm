                            ...
                            if (respTask.list != "") {
                                for (var i = x * 20; i < max_operation; i++) {
                                    ...
                                    if (i < 20 * (x + 1)) {
                                        ...
                                        if(i%20==0){
                                            result.push('                <td width="90" align="center" class="border_r_b" valign="top" rowspan="'+(max_operation - x*20)+'">');
                                            result.push(respTask.list[i].V_GJ_NAME==""?"&nbsp;":subDesc(respTask.list[i].V_GJ_NAME,4));
                                            result.push('&nbsp;</td>');
                                        }

                                        if(i%20==0){
                                            result.push('                <td width="90" align="center" class="border_r_b" valign="top" rowspan="'+(max_operation - x*20)+'">');
                                            result.push(respTask.list[i].V_JSQY_NAME==""?"&nbsp;":subDesc(respTask.list[i].V_JSQY_NAME,7));
                                            result.push('&nbsp;</td>');
                                        }
