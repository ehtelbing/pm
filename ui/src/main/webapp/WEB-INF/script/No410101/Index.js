...
function createPage(orderInfoStore, taskStoreTemp, materialStoreTemp, page) {
    ...
    for (var i = 0; i < taskStoreTemp.getCount(); i++) {
        var record2 = taskStoreTemp.getAt(i);
        s2 = s2 + "<tr>\n" +
                "<td style=\"border-left: 0px; border-bottom: 0px;\">" + record2.get("V_ACTIVITY") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("V_WORK_CENTER") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("V_DESCRIPTION") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("I_WORK_ACTIVITY") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("I_DURATION_NORMAL") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("I_ACTUAL_TIME") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("I_NUMBER_OF_PEOPLE") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("V_JJ_NAME") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("V_GJ_NAME") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("V_JSQY_NAME") + "</td>\n" +
                "<td style=\"border-bottom: 0px;\">" + record2.get("V_AQSC_NAME") + "</td>\n" +
                "</tr>";
    }
    ...
    for (var i = 0; i < materialStoreTemp.getCount(); i++) {
        var record3 = materialStoreTemp.getAt(i);
        s3 = s3 + "<tr>\n" +
                "<td style=\"border-left: 0px; border-bottom: 0px\">" + (i + 1) + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("V_ACTIVITY") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("V_MATERIALCODE") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("V_MATERIALNAME") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("V_UNIT") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("I_PLANAMOUNT") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("F_PLANMONEY") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("I_ACTUALAMOUNT") + "</td>\n" +
                "<td style=\"border-bottom: 0px\">" + record3.get("F_ACTUALMONEY") + "</td>\n" +
                "<td style=\"border-bottom: 0px; border-right: 0px\">" + record3.get("V_MEMO") + "</td>\n" +
                "</tr>";
    }
