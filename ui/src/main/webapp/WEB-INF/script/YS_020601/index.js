...
Ext.onReady(function () {
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: AppUrl + 'YS/YS_CHARGE_WORKORDER_PAY_SEL',
            reader: {
                type: 'json',
                root: 'list',
                total:'total'
    ...
    Ext.getCmp('stateBill').select('已确认');
...
function _querySum(){
    Ext.Ajax.request({
        url: AppUrl + 'YS/YS_CHARGE_W_PAY_TOTAL_SEL',
        async: false,
        method: 'POST',
        params: {
        ...
        Ext.Msg.confirm("提示", "结算单是否要结算？",
            function (button) {
                if (button === "yes") {
                    ...
                    Ext.Ajax.request({
                        url: AppUrl + 'YS/YS_CHARGE_WORKORDER_PAY_SET',
                        method: 'POST',
                        async: false,
                        params: {
