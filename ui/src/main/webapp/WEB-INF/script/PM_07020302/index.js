...
Ext
    .onReady(function () {
        ...
        function OnClickKCRefreshButton() {
            Ext.data.StoreManager.get('KCStore').load({
                params: {
                    ...
                    sap_plantcode: '6005',//Ext.getCmp('selKCPlant').valueModels[0].data.V_SAP_JHGC,
                    sap_departcode: '60050002',//Ext.getCmp('selKCSection').valueModels[0].data.V_SAP_DEPT,
        ...
        Ext.data.StoreManager.get('KCSectionStore').on('load', function () {
            ...
            //            Ext.getCmp('selKCSection').setValue(resp.list[0].V_DEPTCODEREPARIR);
            //        }
            //    }
            //});
