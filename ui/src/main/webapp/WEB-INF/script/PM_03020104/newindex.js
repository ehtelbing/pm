...
var TOPGIRDRIGHTTtool = Ext.create('Ext.grid.Panel', {//form
    ...
    columns: [
        ...
        {text:'通过详情',width: 140, dataIndex: 'PASS_STATE', align: 'center',renderer:viewPDatail},
...
function viewPDatail(value){
    var owidth = window.document.body.offsetWidth - 600;
    var oheight = window.document.body.offsetHeight - 100;
    window.open(AppUrl + 'page/PM_03020104/passDetail.html?guid=' +Guid + '&Defectguid=' + value+'&random=' + Math.random(), '', 'height=' + oheight + ',width=' + owidth + ',top=10px,left=10px,resizable=yes' );
}