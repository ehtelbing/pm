...
Ext.onReady(function () {
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            url: AppUrl + 'hp/GET_DAYPARTCONSUMELIST',
            type: 'ajax',
            actionMethods: {
                read: 'POST'
            },
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [{
            ...
            renderer: function (value, metaData, record, rowIdx, colIdx, store, view) {
                return '<a href="#" onclick="_save(\'' + record.data.DETAIL_ID + '\',\'' + record.data.PART_NO + '\',\'' + record.data.USE_AMOUNT + '\',\'' + record.data.OIL_BEGINDATE + '\',\'' + record.data.OIL_ENDDATE + '\',\'' + record.data.APPROVE + '\')">' + '保存' + '</a>';

               // return '<a href="#" onclick="_save(\''+rowIdx+'\')">' + '保存' + '</a>';
            }
        }, {
            text: '部位编码',
            dataIndex: 'PART_NO',
...
function _save(DETAIL_ID,PART_NO,USE_AMOUNT,OIL_BEGINDATE,OIL_ENDDATE,APPROVE)
{

    var gridStore = Ext.data.StoreManager.lookup('gridStore');
    Ext.Ajax.request({
        url: AppUrl + 'hp/DAYSAVEPARTCONSUME',
        type: 'ajax',
        method: 'POST',
        params: {
            ...
            'A_BEGIN_DATE': Ext.Date.format(new Date(OIL_BEGINDATE), 'Y-m-d'),
            'A_END_DATE':Ext.Date.format(new Date(OIL_ENDDATE), 'Y-m-d'),
            'A_APPROVE': APPROVE,
