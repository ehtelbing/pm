    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns : [ {
            ...
            renderer: function (value, metaData, record, rowIdx, colIdx, store, view) {
                return '<a href="#" onclick="realistic(\'' + record.data.CONSUME_ID + '\',\'' + record.data.INST_EQUIP_CODE + '\')">' + '写实' + '</a>';
            }
        }, {
            text : '日常操作',
            //dataIndex : 'V_TB_PERNAME',
            ...
            width : 100,
            renderer: function (value, metaData, record, rowIdx, colIdx, store, view) {
                return '<a href="#" onclick="dailyRemarks(\'' + record.data.CONSUME_ID + '\',\'' + record.data.INST_EQUIP_CODE + '\')">' + '日常加注' + '</a>';
            }
        }],
        bbar: [{
            id: 'page',
