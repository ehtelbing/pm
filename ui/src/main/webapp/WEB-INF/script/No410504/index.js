Ext
    .onReady(function() {
        ...
        var gridStore = Ext.create('Ext.data.Store', {
            ...
            pageSize : 15,
            autoLoad : false,
            fields : [ 'V_EQUTYPENAME', 'V_CODE', 'V_NAME', 'V_TYPE',
                'V_UNIT', 'V_SETSITE', 'V_MILESTONE', 'V_MEMO' ],
        ...
        Ext.ComponentManager.get('xxxx')
            .on(
            "click",
            function(view, rowIndex, colIndex, item, e) {
                var id = Ext.getCmp('grid').getStore().getAt(
                    colIndex).data.V_MILESTONE

                var owidth = window.document.body.offsetWidth-200;
                var oheight = window.document.body.offsetHeight-100 ;
                var ret = window.open(AppUrl+'page/PM_090901/index.html?V_GUID=' + id + '', '', 'height=' + oheight + ',width=' + owidth + ',top=10px,left=10px,resizable=yes');
            })
