...
function _startAndEndTime(){
    ...
    Ext.getCmp('D_DATE_S').setValue((Ext.util.Format.date(D_DATE_S,'Y-m-d')).toString());
    Ext.getCmp('D_DATE_E').setValue((Ext.util.Format.date(D_DATE_E,'Y-m-d')).toString());
    Ext.getCmp('JD_DATE_S').setValue((Ext.util.Format.date(D_DATE_S, 'Y-m-d')).toString());
    Ext.getCmp('JD_DATE_E').setValue((Ext.util.Format.date(D_DATE_E, 'Y-m-d')).toString());
}
