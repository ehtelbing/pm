...
Ext.onReady(function () {
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        columns: [{xtype: 'rownumberer', text: '序号', width: 50, align: 'center'},
            ...
            {text: '上报时间', width: 130, dataIndex: 'V_INDATE', align: 'center', renderer: atright},
...
function OnButtonOut() {
    ...
    var V_V_CONTENT=Ext.getCmp('content').getValue();
    document.location.href = AppUrl + 'PM_03/PRO_PM_03_PLAN_YEAR_Excel?V_V_YEAR=' + V_V_YEAR
        ...
        + '&V_V_STATE=' + V_V_STATE + '&V_V_ZY=' + V_V_ZY + '&V_V_PERCODE=' + V_V_PERCODE+"&V_V_CONTENT="+V_V_CONTENT;
}
