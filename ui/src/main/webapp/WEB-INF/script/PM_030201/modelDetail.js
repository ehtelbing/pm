...
function OnButtonWorkorder(){  //生成工单
    ...
    window.open(AppUrl + 'page/pm_dxgc_orderEdit/dxWorkOrder.html?guid=' +v_guid + '&random=' + Math.random(), '', 'height=' + oheight + ',width=' + owidth + ',top=10px,left=10px,resizable=yes' );
