...
Ext.onReady(function () {
    ...
    var gridStore = Ext.create('Ext.data.Store', {
        id: 'gridStore',
        autoLoad: false,
        fields: ['V_DEPTCODE', 'V_DEPTNAME', 'V_V_SUMNUM', 'V_V_WCLNUM', 'V_V_WCNUM'],
        proxy: {
            type: 'ajax',
            async: false,
            url: AppUrl + 'cgl/PRO_PM_DEPT_SORT_WCL',
            actionMethods: {
                read: 'POST'
            },
            reader: {
    ...
    var gridPanel = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            // {text : '月份', align : 'center', width : 100, dataIndex : '月份', renderer : aleft},
            {text: '单位', align: 'center', width: 250, dataIndex: 'V_DEPTNAME',renderer:aleft},
            // {text: '作业区', align: 'center', width: 250, dataIndex: 'V_DEPTNAME',renderer:aleft},
            {text: '总数', align: 'center', width: 190, dataIndex: 'V_V_SUMNUM',renderer:left},
            {text: '完成数', align: 'center', width: 190, dataIndex: 'V_V_WCLNUM',renderer:left},
...
function OnClickExcelButton() {
    ...
    document.location.href = AppUrl + 'excel/GDCX_EXCEL_WCL?V_V_YEAR=' + Ext.getCmp('nf').getValue()
