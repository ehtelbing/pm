...
if (location.href.split('?')[1] != undefined) {
    if (Ext.urlDecode(location.href.split('?')[1]) != null) {
        ...
        v_menucode = Ext.urlDecode(location.href.split('?')[1]).v_menucode;
    }
}
...
function OnPageLoaded() {
    ...
    append('Index2', '首页', AppUrl + "page/home/home" + ".html", false);
   ...
   /* Ext.Ajax.request({
    ...
    Ext.Ajax.request({
        url: AppUrl + 'anewhome/sel_menu_tree_id',
        params: {
            IS_V_ROLECODE: Ext.util.Cookies.get('v_rolecode'),
            IS_V_SYSTYPE: '1',
            V_V_DEPTCODE: Ext.util.Cookies.get('v_orgCode'),
            V_V_MENUCODE: v_menucode
        },
        method: 'post',
        sync: true,
        success: function (response) {
