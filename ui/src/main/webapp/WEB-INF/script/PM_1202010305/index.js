...
var gridStore = Ext.create("Ext.data.Store", {
	...
	proxy : {
		type : 'ajax',
		async : false,
		url : AppUrl + 'PM_12/PRO_RUN7116_SELECT',
		actionMethods : {
			read : 'POST'
		},
		reader : {
...
function OnButtonExportClicked() {
	...
	'&V_V_BEGIN_DATE='+Ext.Date.format(Ext.getCmp('startTime').getValue(), 'Y-m-d')+
	'&V_V_END_DATE='+Ext.Date.format(Ext.getCmp('endTime').getValue(), 'Y-m-d');
}
