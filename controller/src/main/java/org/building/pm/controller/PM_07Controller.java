...
//    return result;
    ...
    /*缺陷手工录入保存*/
    @RequestMapping(value = "/PRO_PM_07_DEFECT_SET_H", method = RequestMethod.POST)
    @ResponseBody
    public Map PRO_PM_07_DEFECT_SET_H(@RequestParam(value = "V_V_GUID") String V_V_GUID,
                                    @RequestParam(value = "V_V_PERCODE") String V_V_PERCODE,
                                    @RequestParam(value = "V_V_PERNAME") String V_V_PERNAME,
                                    @RequestParam(value = "V_V_INPERCODE") String V_V_INPERCODE,
                                    @RequestParam(value = "V_V_INPERNAME") String V_V_INPERNAME,
                                    ...
                                    @RequestParam(value = "V_V_LEVEL") String V_V_LEVEL,
                                    @RequestParam(value = "V_V_PROWAY") String V_V_PROWAY,
                                      @RequestParam(value = "V_V_HANDSIGN") String V_V_HANDSIGN,
                                    HttpServletRequest request,
                                    HttpServletResponse response) throws Exception {
        Map result = pm_07Service.PRO_PM_07_DEFECT_SET_H(V_V_GUID, V_V_PERCODE,V_V_PERNAME,V_V_INPERCODE,V_V_INPERNAME,V_V_DEFECTLIST, V_V_SOURCECODE,
                V_V_SOURCEID, V_D_DEFECTDATE, V_V_DEPTCODE, V_V_EQUCODE, V_V_EQUCHILDCODE, V_V_IDEA,
                V_V_LEVEL,V_V_PROWAY,V_V_HANDSIGN);
        return result;
    }
    /*缺陷手工录入修改*/
    @RequestMapping(value = "/PRO_PM_07_DEFECT_UPDATE", method = RequestMethod.POST)
    @ResponseBody
    public Map PRO_PM_07_DEFECT_UPDATE(@RequestParam(value = "V_V_GUID") String V_V_GUID,
                                      @RequestParam(value = "V_V_PERCODE") String V_V_PERCODE,
                                      @RequestParam(value = "V_V_PERNAME") String V_V_PERNAME,
                                      @RequestParam(value = "V_V_INPERCODE") String V_V_INPERCODE,
                                      @RequestParam(value = "V_V_INPERNAME") String V_V_INPERNAME,
                                      ...
                                      HttpServletRequest request,
                                      HttpServletResponse response) throws Exception {
        Map result = pm_07Service.PRO_PM_07_DEFECT_UPDATE(V_V_GUID, V_V_PERCODE,V_V_PERNAME,V_V_INPERCODE,V_V_INPERNAME,V_V_DEFECTLIST, V_V_SOURCECODE,
                V_V_SOURCEID, V_D_DEFECTDATE, V_V_DEPTCODE, V_V_EQUCODE, V_V_EQUCHILDCODE, V_V_IDEA,
                V_V_LEVEL,V_V_PROWAY,V_V_HANDSIGN);
        return result;
    }
    /*缺陷是否可修改查找*/
    @RequestMapping(value = "/PRO_PM_07_DEFECT_UPDT_SEL", method = RequestMethod.POST)
    @ResponseBody
    public Map PRO_PM_07_DEFECT_UPDT_SEL(@RequestParam(value = "V_V_GUID") String V_V_GUID,
